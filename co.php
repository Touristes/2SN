       ...
       function ValiderMail1(formulaire1) {
        if (formulaire1.login.value == "") {alert("Pseudo saisi invalide.\n")}
         ...
         <div id="inline">
          ...
          <div id="reset">
            <?php if ($_SESSION['fail'] == 1) echo "<a href=\"reinitPassword.php\">Tu as oublié ton mot de passe ?</a>"; $_SESSION['fail'] = 0;?></div>
            <div id="inscription">
              Nouveau sur [Why] ?</br></br>
              <form id="signup" name="monform" method="post" action="traite.php">
                <input type="email" placeholder="pwet.lagalette@email.com" name="mail" required style="width:90%;">
            ...
            <div id="presentation">
              ...
              <p>Sur [Why], pas de photos du repas de ton collègue de boulot ni d'échographie de ta voisine ; de l'info, seulement de l'info, rien que de l'info. Et c'est toi, utilisateur, qui vote pour l'info la plus pertinente du jour, affichée en tête de page pendant 24h !</p>
              <p>En plus, [Why] respecte ta vie privée : nous ne collectons aucune donnée sur toi et effaçons tes billets dès 7 jours d'existence. Focus sur l'actualité !</p>
